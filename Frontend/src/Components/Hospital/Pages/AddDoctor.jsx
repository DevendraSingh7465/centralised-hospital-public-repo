...
const AddDoctor = () => {
  ...
  const AddnewDoctor = async (data) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_BACKEND}/hospital/addDoctor`, data, {
        withCredentials: true,
      });
    ...
    <div className="p-2">
      ...
      <div className="breadcrumbs text-sm">
        <ul className="">
          ...
          <li className="text-emerald-500">Add Doctor</li>
        </ul>
      </div>
      ...
      <section className="text-black">
        <div className="flex justify-start items-center">
          <h1 className="text-2xl font-bold py-3">Add Doctor</h1>
        </div>
        <div className="rounded border-1 border-gray-300 p-3">
          <div className="">
            <h1 className="font-bold text-2xl m-1">Doctor Details</h1>
          </div>
          <form onSubmit={handleSubmit((data) => AddnewDoctor(data))}>
